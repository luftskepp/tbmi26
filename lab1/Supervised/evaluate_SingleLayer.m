...
numSamplesPerLabelPerBin = 200; % Number of samples per label per bin, set to inf for max number (total number is numLabels*numSamplesPerBin)
...
numIterations = 100000; % Change this, Numner of iterations (Epochs)
learningRate = 0.00000001; % Change this, Your learningrate
W0 = 0; % Change this, Initiate your weight matrix W

W0 = 0.01*randn(length(unique([Lt{1:end}])), size(Xtest,1));
